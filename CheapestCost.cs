...
namespace Algs {
    ...
    class Solution {
        ...
        public static int getCheapestCost(Node rootNode) {
            ...
            int cheapestChildCost = -1;
            foreach (var child in rootNode.children) {
                var cost = getCheapestCost(child);
                if (cheapestChildCost == -1 || cost < cheapestChildCost) cheapestChildCost = cost;
            }
            return cheapestChildCost + rootNode.cost;
        }
